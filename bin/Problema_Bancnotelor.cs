// Dafny program Problema_Bancnotelor.dfy compiled into C#
...
// Command Line Options: c:\Users\Contur Alexandra\Desktop\Dafny_Licenta\Problema_Bancnotelor.dfy /verifyAllModules /spillTargetCode:1 /compile:3 /out:bin\Problema_Bancnotelor
// Problema_Bancnotelor.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger maximRest(BigInteger suma)
    {
      BigInteger s = BigInteger.Zero;
      if ((new BigInteger(16)) <= (suma)) {
        s = new BigInteger(16);
      } else if ((new BigInteger(8)) <= (suma)) {
        s = new BigInteger(8);
      } else if ((new BigInteger(4)) <= (suma)) {
        s = new BigInteger(4);
      } else if ((new BigInteger(2)) <= (suma)) {
        s = new BigInteger(2);
      } else {
        s = BigInteger.One;
      }
    ...
    public static Dafny.ISequence<BigInteger> bancnoteMin(BigInteger sum)
    {
      Dafny.ISequence<BigInteger> sol = Dafny.Sequence<BigInteger>.Empty;
      BigInteger _0_rest;
      _0_rest = sum;
      BigInteger _1_s1;
      _1_s1 = BigInteger.Zero;
      BigInteger _2_s2;
      _2_s2 = BigInteger.Zero;
      BigInteger _3_s4;
      _3_s4 = BigInteger.Zero;
      BigInteger _4_s8;
      _4_s8 = BigInteger.Zero;
      BigInteger _5_s16;
      _5_s16 = BigInteger.Zero;
      BigInteger _6_s;
      _6_s = BigInteger.Zero;
      while ((_0_rest).Sign == 1) {
        BigInteger _out0;
        _out0 = __default.maximRest(_0_rest);
        _6_s = _out0;
        if ((_6_s) == (new BigInteger(16))) {
          _5_s16 = (_5_s16) + (BigInteger.One);
        } else if ((_6_s) == (new BigInteger(8))) {
          _4_s8 = (_4_s8) + (BigInteger.One);
        } else if ((_6_s) == (new BigInteger(4))) {
          _3_s4 = (_3_s4) + (BigInteger.One);
        } else if ((_6_s) == (new BigInteger(2))) {
          _2_s2 = (_2_s2) + (BigInteger.One);
        } else {
          _1_s1 = (_1_s1) + (BigInteger.One);
        }
        _0_rest = (_0_rest) - (_6_s);
      }
      sol = Dafny.Sequence<BigInteger>.FromElements(_5_s16, _4_s8, _3_s4, _2_s2, _1_s1);
      return sol;
    }
    public static void _Main(Dafny.ISequence<Dafny.ISequence<char>> __noArgsParameter)
    {
      BigInteger _7_sum;
      _7_sum = new BigInteger(49);
      BigInteger[] _8_bancnote;
      ...
      _8_bancnote = _nw0;
      BigInteger _rhs0 = new BigInteger(16);
      BigInteger _rhs1 = new BigInteger(8);
      BigInteger _rhs2 = new BigInteger(4);
      BigInteger _rhs3 = new BigInteger(2);
      BigInteger _rhs4 = BigInteger.One;
      BigInteger[] _lhs0 = _8_bancnote;
      BigInteger _lhs1 = BigInteger.Zero;
      BigInteger[] _lhs2 = _8_bancnote;
      BigInteger _lhs3 = BigInteger.One;
      BigInteger[] _lhs4 = _8_bancnote;
      BigInteger _lhs5 = new BigInteger(2);
      BigInteger[] _lhs6 = _8_bancnote;
      BigInteger _lhs7 = new BigInteger(3);
      BigInteger[] _lhs8 = _8_bancnote;
      BigInteger _lhs9 = new BigInteger(4);
      ...
      BigInteger _9_n;
      _9_n = new BigInteger(5);
      Dafny.ISequence<BigInteger> _10_sol;
      Dafny.ISequence<BigInteger> _out1;
      _out1 = __default.bancnoteMin(_7_sum);
      _10_sol = _out1;
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("Restul optim pentru suma "));
      Dafny.Helpers.Print(_7_sum);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString(" este: \n"));
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("Numarul bancnote de 16:"));
      Dafny.Helpers.Print((_10_sol).Select(BigInteger.Zero));
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("\n Nr bancnote de 8:"));
      Dafny.Helpers.Print((_10_sol).Select(BigInteger.One));
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("\n Nr bancnote de 4:"));
      Dafny.Helpers.Print((_10_sol).Select(new BigInteger(2)));
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("\n Nr bancnote de 2:"));
      Dafny.Helpers.Print((_10_sol).Select(new BigInteger(3)));
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("\n Nr bancnote de 1:"));
      Dafny.Helpers.Print((_10_sol).Select(new BigInteger(4)));
    }
  }
